...
import static main.MainApp.editMode;
import static main.MainApp.tabIndex;
...
public class PersonEditDialogController {
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            if(editMode){
                if (tabIndex == 1){
                    ed.editPatient((Patient) person);
                } else if(tabIndex == 2){
                    ed.editPerson((Personal) person);
                }
            } else {
                if (tabIndex == 1){
                    ed.newPatient((Patient) person);
                } else if(tabIndex == 2){
                    ed.newPerson((Personal) person);
                }
            }
