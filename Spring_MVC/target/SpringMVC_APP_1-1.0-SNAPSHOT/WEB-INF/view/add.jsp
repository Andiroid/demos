...
<div style="font-family:verdana;">
    <div id="patient-form-wrap">
        <div id="patient-form-inner">
            <fieldset>
                <legend><strong>Neuer Patient</strong></legend>

        <form:form  modelAttribute="patientObject" method="POST" action="addProcess">
            <table>
                <tr>
...
<%--                    </td>--%>
<%--                    <td>--%>
<%--                            &lt;%&ndash;                    <form:form method="GET" action="schueler">&ndash;%&gt;--%>
<%--                            &lt;%&ndash;                        <input type="submit" value="Abbrechen"/>&ndash;%&gt;--%>
